...
> [!WARNING]
> OrcaCD is in active development and configuration may change often. Please make sure to carefully read the release notes before updating.
...
You can find documentation and guides on all of the available configuration of OrcaCD in the [website](https://orcacd.github.io/docs/).

If you wish to contribute to the documentation head over to the [repository](https://github.com/OrcaCD/docs).

## Contribute

You're very welcome to contribute to OrcaCD! Please follow the [contribution guide](/CONTRIBUTING.md) to get started.