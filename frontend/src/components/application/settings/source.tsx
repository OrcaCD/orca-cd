                    ...
                    <div className="bg-card border border-border rounded-lg p-6 space-y-6">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="space-y-2">
                                ...
                                <Input id="path" defaultValue="/docker-compose.yml" className="bg-muted border-border" />
                            </div>
                        </div>
                    ...
                    <div className="bg-card border border-border rounded-lg p-6 space-y-6">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="space-y-2">
                                ...
                                <Input id="deployPath" defaultValue="/opt/apps/api-gateway" className="bg-muted border-border" />
                            </div>
                        </div>
