...
type Provider interface {
	...
	// Returns decoded file content for a repository file at the given ref.
	GetFileContent(ctx context.Context, repo *models.Repository, ref string, path string) (string, error)
