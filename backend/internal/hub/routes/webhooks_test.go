...
func TestGenericWebhookResolve_CommitProvided_SkipsGetLatestCommit(t *testing.T) {
	...
	applications.SyncApplications(context.Background(), &repo, provider, apps, applications.StaticCommit("provided-sha", ""), applications.QueueLogger())
...
func TestGenericWebhookResolve_NoCommit_FetchesLatestCommitPerBranch(t *testing.T) {
	...
	applications.SyncApplications(context.Background(), &repo, provider, apps, applications.LatestCommit(provider, &repo), applications.QueueLogger())
