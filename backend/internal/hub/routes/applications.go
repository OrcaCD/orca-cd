...
func CreateApplicationHandler(c *gin.Context) {
	...
	utils.RecordAuditLog(c, db.DB, "application.created", "application", application.Id)
...
func UpdateApplicationHandler(c *gin.Context) {
	...
	utils.RecordAuditLog(c, db.DB, "application.updated", "application", id)
...
func DeleteApplicationHandler(c *gin.Context) {
	...
	utils.RecordAuditLog(c, db.DB, "application.deleted", "application", id)
